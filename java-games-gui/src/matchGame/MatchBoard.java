...
import javax.persistence.Table;
	...
	@Table (catalog="gaming_score", name = "matching")
	@NamedQueries({
		@NamedQuery(name="matchScore.getAll", query="SELECT p FROM MatchBoard p"),
	})
	...
	public class MatchBoard {
		...
		public MatchBoard(String gameWinner, int theRound, String theScore, String theStat, String theTime) { //, int theSequence) {
			super();
