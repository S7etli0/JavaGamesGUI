package lineGame;
	...
	public class FourLineGame extends JPanel {
			...
			public FourLineGame() {	
				...
				pnlPic.add(lblpic);	
				ImageIcon loginPic = new ImageIcon("pics/redyellrow.png");
				...
				JLabel title = new JLabel("FourInline");
				...
				panelGame.setLayout(new GridLayout(space1,space2));
				button = new JButton [space1][space2];
				
				Random gen =  new Random();		
				button = ComboMethods.setBase(button, panelGame," ",45);														
							...
							btn1.addActionListener (new ActionListener() {						
								public void actionPerformed(ActionEvent a) {																	
									...
									if (stop == false) {
										...
										if ((A==button.length-1)||(button[A+1][B]).getText().equals(" ")==false) {
											...
											if (btn1.getText().equals(" ")) {
												...
												win = ComboMethods.whoHasaLine(button,player,space1,space2);
											}
										}
		...
		public static void WinnerData(String P1, String P2) {		
			...
			FourLineBoard board = new FourLineBoard(playing+": "+currentPlayer,(turn),score,draw,gameDate);
