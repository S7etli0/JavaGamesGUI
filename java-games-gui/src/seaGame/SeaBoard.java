...
@Table (catalog="gaming_score", name = "tictactoe")
@NamedQueries({
	@NamedQuery(name="seaScore.getAll", query="SELECT p FROM SeaBoard p"),
})
...
public class SeaBoard {
	...
	public SeaBoard(String gameWinner, int theRound, String theScore, int theTie, String theTime) { //, int theSequence) {
		super();
